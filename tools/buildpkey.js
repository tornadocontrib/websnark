...
if (argv.help || argv.h) {
    console.log(`node buildpkey.js -i "proving_key.json" -o "proving_key.bin"
-i --input default: proving_key.json
-o --output default: proving_key.bin
-h --help
...
const inputName = argv.input || argv.i || "proving_key.json";
